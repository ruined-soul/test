...
mafia_logo = "H1M4N5HU0P/IMG_20210517_133913_921.jpg"
...
async def send(event):
    ...
    omk = f"**𝙿𝙻𝚄𝙶𝙸𝙽 𝙽𝙰𝙼𝙴 ➳➠** `{input_str}`\n**𝚄𝙿𝙻𝙾𝙰𝙳𝙴𝙳 𝙱𝚈 ➳➠** {mafia}\n\n⚜️ **[ȴꬴꬶꬴꬼɖᶏꭉỿ ᶏƒ ꬴᶏꬶȴꬴ ꬺᶏƒᶖᶏ ɓꝍȶ](t.me/@EAGLE_MAFIA_USERBOT)** ⚜️"
                ...
                if shortname in CMD_LIST:
                    ...
                    for i in CMD_LIST[shortname]:
                        ...
                        if b == 1:
                            ...
                            b = 1
                        await event.edit(a)
                    return await event.edit(f"✅ **Installed module** :- `{shortname}` \n✨ BY :- {mafia}\n\n{string}\n\n        ⚡ **[LEGENDARY AF EAGLE MAFIA BOT](t.me/EAGLE_MAFIA_USERBOT)** ⚡", link_preview=False)
