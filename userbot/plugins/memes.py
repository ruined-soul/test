...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/sameerpanthi/EAGLE-MAFIA-BOT) to open this 🔥**Lit AF!!**🔥 __EAGLEMAFIABOT__ Repo.. Join channel :- @EAGLE_MAFIA_USERBOT")
