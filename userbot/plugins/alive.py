...
pm_caption += f"┣•➾𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 `1.15.0` \n\n"
pm_caption += f"┣•➾𝙴𝙰𝙶𝙻𝙴 𝙱𝙾𝚃 ☞ : `{mafiaversion}`\n\n"
pm_caption += f"┣•➾𝚂𝚄𝙳𝙾 ☞          : `{sudou}`\n\n"
pm_caption += f"┣•➾𝚄𝚂𝙴𝚁𝙱𝙾𝚃 𝙶𝚁𝙾𝚄𝙿 ☞  : [𝙹𝙾𝙸𝙽](https://t.me/EAGLE_MAFIA_USERBOT)\n\n"
pm_caption += f"┣•➾𝙲𝚁𝙴𝙰𝚃𝙾𝚁 ☞    : [𝚂𝙸𝙳𝙳𝙷𝙰𝚁𝚃𝙷](https://t.me/Owner_of_team_eagle_mafia)\n\n"
pm_caption += f"┣•➾𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝙴𝚁 ☞    :[𝚃𝙴𝙰𝙼 EAGLE](https://t.me/eagle_with_sucker)\n\n"
pm_caption += f"┗━━━━━━━━━━━━━━━━━━━\n"
