...
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's 𝔼𝔸𝔾𝕃𝔼 𝕄𝔸𝔽𝕀𝔸 𝔹𝕆𝕋.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **𝔼𝔸𝔾𝕃𝔼 𝕄𝔸𝔽𝕀𝔸 𝔹𝕆𝕋 Ultra Private Security Protocol⚠️**.\n"
