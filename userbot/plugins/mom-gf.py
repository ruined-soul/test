...
async def _(event):
    ...
    animation_chars = [
        "`Ruk jaa , Abhi teri sndnGF ko Fuck karta hu `",
        "`Makinnnnng your Gf warm 🔥`",
        "`Pressijjnnnjnng her boobs 🤚😘`",
        "`Stimulnnkating her pussy🖕`",
        "`Fingennring her pussy 💧😍👅 `",
        "`Askingjnnmm her to taste my DICK🍌`",
